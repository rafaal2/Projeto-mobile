...
import com.ifpe.projetomobile.deolhonaconsulta.deolhonaconsulta.data.Api.response.ConsultaDetResponse
...
class ConsultaDetRepository(private val httpClient: HttpClient) {
    ...
    suspend fun consultaDet(codSolicitacao: String): ConsultaDetResponse {
        return httpClient.post("http://10.0.2.2/ApiOlho/api/solicitacao.php?acao=info") {
